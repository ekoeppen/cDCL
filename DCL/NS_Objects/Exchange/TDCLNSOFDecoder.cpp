...
{
	// Lecture & vŽrification de la version.
...
TDCLNSOFDecoder::GetNextObject( void )
{
	...
	// Suivant le type, lecture de l'objet (ou rŽcupŽration de l'objet dans
	// la liste de ceux dŽjˆ lus).
	TDCLNSRef theResult;
