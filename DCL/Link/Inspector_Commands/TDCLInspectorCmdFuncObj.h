// ==============================
// File:			TDCLInspectorCmdFuncObj.h
...
// License.
//
// The Original Code is TDCLInspectorCmdFuncObj.h.
//
...
#ifndef __TDCLINSPECTORCMDFUNCOBJ__
#define __TDCLINSPECTORCMDFUNCOBJ__

#include <DCL/Headers/DCLDefinitions.h>
#include <DCL/Link/Inspector_Commands/TDCLInspectorCommand.h>

class TDCLInspectorCmdFuncObj: public TDCLInspectorCommand
{
public:
									TDCLInspectorCmdFuncObj( KUInt32 inLength = 0, const void* inData = nil );
};
