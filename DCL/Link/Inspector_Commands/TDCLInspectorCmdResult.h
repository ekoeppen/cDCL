...
// License.
//
// The Original Code is TDCLInspectorCmdResult.h.
//
...
#ifndef __TDCLINSPECTORCMDRESULT__
#define __TDCLINSPECTORCMDRESULT__

#include <DCL/Headers/DCLDefinitions.h>
#include <DCL/Link/Inspector_Commands/TDCLInspectorCommand.h>

class TDCLInspectorCmdResult: public TDCLInspectorCommand
{
public:
									TDCLInspectorCmdResult( KUInt32 inLength = 0, const void* inData = nil );
};
