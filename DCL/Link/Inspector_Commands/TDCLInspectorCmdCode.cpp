...
// License.
//
// The Original Code is TDCLInspectorCmdCode.cpp.
//
...
TDCLInspectorCmdCode::TDCLInspectorCmdCode( KUInt32 inLength, const void* inData ):
	TDCLInspectorCommand( kDCode, inLength, inData )
{
}

KUInt32 TDCLInspectorCmdCode::SendHeader( TDCLStream* inStream )
{
	KUInt32 someLong;
