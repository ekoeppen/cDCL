...
// License.
//
// The Original Code is TDCLInspectorCmdCode.h.
//
...
#ifndef __TDCLINSPECTORCMDCODE__
#define __TDCLINSPECTORCMDCODE__

#include <DCL/Headers/DCLDefinitions.h>
#include <DCL/Link/Inspector_Commands/TDCLInspectorCommand.h>

class TDCLInspectorCmdCode: public TDCLInspectorCommand
{
public:
									TDCLInspectorCmdCode( KUInt32 inLength = 0, const void* inData = nil );
