...
// License.
//
// The Original Code is TDCLInspectorCmdText.cpp.
//
...
TDCLInspectorCmdText::TDCLInspectorCmdText(	KUInt32 inLength, const void* inData ):
	TDCLInspectorCommand( kDText, inLength, inData )
{
}
